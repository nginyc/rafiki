...
As an *Admin*, you can manage users, datasets, models, train jobs & inference jobs on SingaAuto. This guide only highlights the key methods available to manage users.
...
.. seealso:: :meth:`singaauto.client.Client.create_user`
...
.. seealso:: :meth:`singaauto.client.Client.get_users`
...
.. seealso:: :meth:`singaauto.client.Client.ban_user`