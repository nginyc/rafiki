...
class LoggerUtils():
    ...
    def define_loss_plot(self):
        ...
        To be used with :meth:`singaauto.model.LoggerUtils.log_loss`.
        '''
    ...
    def log_loss(self, loss, epoch):
        ...
        To be used with :meth:`singaauto.model.LoggerUtils.define_loss_plot`.
        '''
    ...
    def define_plot(self, title, metrics, x_axis=None):
        ...
        Only call this method in :meth:`singaauto.model.BaseModel.train`.
    ...
    def log(self, msg='', **metrics):
        ...
        Logged messages will be viewable on SingaAuto's administrative UI. 
        
        To visualize logged metrics on plots, a plot must be defined via :meth:`singaauto.model.LoggerUtils.define_plot`.

        Only call this method in :meth:`singaauto.model.BaseModel.train` and :meth:`singaauto.model.BaseModel.evaluate`.
    ...
    # During model training, this method will be called by SingaAuto to inject a Python logger 
...
class LoggerUtilsDebugHandler(logging.Handler):
    ...
    def emit(self, record):
        ...
        if log_type == LogType.PLOT:
            ...
            self._print('Plot `{}` will be registered when this model is being trained on SingaAuto' \
