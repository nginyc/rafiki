...
from singaauto.constants import TrainJobStatus, UserType, \
...
class MetaStore(object):
    def __init__(self, **kwargs):
        ...
        user = kwargs.get('postgres_user', os.environ.get('POSTGRES_USER', 'singaauto'))
        db = kwargs.get('postgres_db', os.environ.get('POSTGRES_DB', 'singaauto'))
        password = kwargs.get('postgres_password', os.environ.get('POSTGRES_PASSWORD', 'singaauto'))
