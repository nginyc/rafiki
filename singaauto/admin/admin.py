...
from singaauto.constants import ServiceStatus, UserType, TrainJobStatus, ModelAccessRight, InferenceJobStatus
from singaauto.config import SUPERADMIN_EMAIL, SUPERADMIN_PASSWORD
from singaauto.meta_store import MetaStore
from singaauto.model import LoggerUtils
from singaauto.container import DockerSwarmContainerManager 
from singaauto.data_store import FileDataStore, DataStore
...
class Admin(object):
    def __init__(self, meta_store=None, container_manager=None, data_store=None, param_store=None):
        ...
        self._base_worker_image = '{}:{}'.format(os.environ['SINGAAUTO_IMAGE_WORKER'],
                                                os.environ['SINGAAUTO_VERSION'])
