...
from singaauto.constants import ServiceStatus, ServiceType, BudgetOption, InferenceBudgetOption, TrainJobStatus, InferenceJobStatus
from singaauto.meta_store import MetaStore
from singaauto.container import DockerSwarmContainerManager, ContainerManager, ContainerService
from singaauto.model import parse_model_install_command
...
class ServicesManager(object):
    ...
    def __init__(self, meta_store=None, container_manager=None, 
        ...
        version = os.environ['SINGAAUTO_VERSION']
        ...
        self._predictor_image = f"{os.environ['SINGAAUTO_IMAGE_PREDICTOR']}:{version}"
        self._predictor_port = os.environ['PREDICTOR_PORT']
        self._app_mode = os.environ['APP_MODE']
        self._singaauto_addr = os.environ['SINGAAUTO_ADDR']
        self._app_mode = os.environ['APP_MODE']
    ...
    def _create_service(self, service_type, docker_image,
        ...
        environment_vars = {
            ...
            **environment_vars,
            'SINGAAUTO_SERVICE_ID': service.id,
            'SINGAAUTO_SERVICE_TYPE': service_type,
        ...
        if container_port is not None:
            ext_hostname = self._singaauto_addr
            ext_port = self._get_available_ext_port()
            publish_port = (ext_port, container_port)

        try:
            container_service_name = 'singaauto_service_{}'.format(service.id)
